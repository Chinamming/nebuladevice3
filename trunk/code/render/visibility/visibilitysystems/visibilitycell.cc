...
VisibilityCell::AttachContext(const Ptr<VisibilityContext>& context)
{
    ...
    n_assert(context->GetGfxEntity()->GetType() < InternalGraphicsEntityType::NumTypes);
...
*/
void
VisibilityCell::UpdateNumEntitiesInHierarchy(InternalGraphicsEntityType::Code type, int num)
{
