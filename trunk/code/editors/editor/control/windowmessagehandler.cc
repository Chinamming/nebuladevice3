...
//------------------------------------------------------------------------------
WindowMessageHandler::WindowMessageHandler(HWND hwnd) :
	hWnd(hwnd)
{
	// empty
}
...
//------------------------------------------------------------------------------
void
WindowMessageHandler::OnMouseButton(UINT uMsg, LPARAM lParam)
{
...
//------------------------------------------------------------------------------
void
WindowMessageHandler::OnMouseMove(LPARAM lParam)
{
	float2 absMousePos = this->ComputeAbsMousePos(lParam);
	float2 normMousePos = this->ComputeNormMousePos(absMousePos);
	this->NotifyEventHandler(DisplayEvent(DisplayEvent::MouseMove, absMousePos, normMousePos));
}

//------------------------------------------------------------------------------
void
WindowMessageHandler::OnMouseWheel(WPARAM wParam)
{
